    ...
    render() {
        ...
        return (
            <div className="concrete-content">
                  ...
                  <div className={"concrete-name-movie"}>
                    {post.title}
                    <label >{"   (Reiting in our konopoisk:" + post.vote_average + ")"} </label>
                    <label>(Reiting in our sait: {this.newReiting(this.state.data)} )</label>
                  </div>
                  <div>
                    Обзор:
                  </div>
