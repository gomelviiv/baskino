...
<b>3.</b> Grant of License to Us for Contributions
...
<br/>
<h2>4. Grant of License to You to use Contributions for Personal, Non-Commercial Purposes</h2>
<br/>  <br/>
...
<b>4.2</b> License Restrictions.
  <br/>  <br/>

  <b>4.2.1</b> Retention of IP Notices. If you download, copy or print a copy of the Materials (as defined in Section 6 below) for your own personal use, you must retain all trademark, copyright and other proprietary notices contained in and on the materials.
  <br/>  <br/>

  <b>4.2.2</b> No Circumvention of IP Protection Mechanisms. You shall not either directly or through the use of any device, software, internet site, web-based service or other means remove, alter, bypass, avoid, interfere with, or circumvent any copyright, trademark, or other proprietary notices marked on Contributions or any digital rights management mechanism, device, or other content protection or access control measure associated with Contributions or the Site.
  <br/>  <br/>

  <b>4.2.3</b> No Unauthorized Copying, Broadcasting or Screen Scraping. You shall not either directly or through the use of any device, software, internet site, web-based service or other means copy, download, reproduce, duplicate, archive, distribute, upload, publish, modify, translate, broadcast, perform, display, sell, transfer, rent, sub-license, transmit or retransmit Contributions except as permitted in Section 4.1.
  <br/>  <br/>

  <b>4.2.4</b> No Indexing. Furthermore, you may not create, recreate, distribute or advertise an index of any Contributions unless authorized by us in writing.
  <br/>  <br/>

  <b>4.2.5</b> No Commercial Use of Contributions. You may not build a business utilizing the Contributions, whether or not for profit. Contributions covered by these restrictions include without limitation any text, graphics, layout, interface, logos, photographs, audio and video materials, and stills.
  <br/>  <br/>

  <b>4.2.6</b> No Derivative Works. In addition, you are strictly prohibited from creating derivative works or materials that otherwise are derived from or based on Contributions in any way, including montages, wallpaper, desktop themes, greeting cards, and merchandise, unless it is expressly permitted by us in writing. This prohibition applies even if you intend to give away the derivative materials free of charge.
  <br/>  <br/>
...
<h2>14. Disclaimers</h2>
  <br/>
ALL CONTRIBUTIONS OR ANY OTHER MATERIALS OR ITEMS PROVIDED THROUGH THIS SITE BY US ARE PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTY OR CONDITIONS OF ANY KIND. By operating this Site, WE DO not represent or imply that WE ENDORSE any Contributions or any other Materials or items available on or linked to by this Site, including without limitation, content hosted on third party Sites, or that WE BELIEVE Contributions or any other Materials or items to be accurate, useful or non-harmful. <br/>
WE cannot guarantee and do not promise any specific results from use of this Site. No advice or information, whether oral or written, obtained by you from US or this Site shall create any warranty not expressly stated In THIS AGREEMENT. YOU AGREE THAT YOUR USE OF THIS SITE AND SERVICES WILL BE AT YOUR SOLE RISK. WE DO NOT WARRANT THAT THE SITE OR SERVICES WILL BE AVAILABLE FOR USE, AND WE DO NOT MAKE ANY WARRANTIES AS TO THE QUALITY OF THE SITE, SERVICES OR ITS CONTENT. TO THE FULLEST EXTENT PERMITTED BY LAW, WE AND EACH OF OUR ADVERTISERS, LICENSORS, SUPPLIERS, OFFICERS, DIRECTORS, INVESTORS, EMPLOYEES, AGENTS, SERVICE PROVIDERS AND OTHER CONTRACTORS DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED IN CONNECTION WITH THIS SITE AND YOUR USE THEREOF.
<br/>
...
<h2>17. Miscellaneous</h2>
  ...
  <b>17.1</b> Entire Agreement. This Agreement (and our Privacy Policy) constitutes the entire agreement between you and us regarding the use of this Site and Services and supersedes any prior or contemporaneous understandings and agreements between you and us related to the subject matter hereof.
  <br/>  <br/>

  <b>17.2</b> Independent Contractors. Nothing in this Agreement shall be deemed to create an agency, partnership, joint venture, employer-employee or franchisor-franchisee relationship of any kind between us and any user.
  <br/>  <br/>

  <b>17.3</b> No Third Party Beneficiaries. This Agreement is between you and us. There are no third-party beneficiaries to this Agreement.
  <br/>  <br/>

  <b>17.4</b> Section Titles. The section titles in this Agreement are for convenience only and have no legal or contractual effect.
  <br/>  <br/>

  <b>17.5</b> Non-Waiver. Our failure to exercise or enforce any right or provision of this Agreement shall not operate as a waiver of such right or provision.
  <br/>  <br/>

  <b>17.6</b> Severability. This Agreement operates to the fullest extent permissible by law. If any provision or part of a provision of this Agreement is unlawful, void, or unenforceable, that provision or part of the provision is deemed severable from this Agreement and shall not affect the validity and enforceability of any remaining provisions.
  <br/>  <br/>

  <b>17.7</b> Assignment. You may not assign your rights under this Agreement to any third party; we may assign our rights under this Agreement without condition.
  <br/>  <br/>

  <b>17.8</b> NOTICES. Any notice to be sent to you under this Agreement may be sent via email, post, or any other reasonable means, at the contact information provided by you to TMDb from time to time. It is your obligation to insure that this information is current. Please send any notices to Fanhattan, Inc at 489 S. El Camino Real, San Mateo, CA, 94402 and e-mail privacy@fan.tv
  <br/>  <br/>

This Agreement was last updated on: January 23, 2015.
              </div>
            </div>
        )
    }
